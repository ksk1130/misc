   ...
   1. 準備
      ...
      7. ~~Spectrum準備~~
         ...
         1. ~~スキーマ作成~~
            ...
            1. ```sql
               ...
               database 'testdb' 
               iam_role 'arn:aws:iam::102478898864:role/RedshiftSpectrumRole'
      ...
      8. ~~Redshift準備~~
         1. ~~copy文準備~~
            ...
            1. ```sql
               copy varchar_test_rs from 's3://euks-testbucket/varchar_test/data/' 
               iam_role 'arn:aws:iam::102478898864:role/RedshiftSpectrumRole' delimiter ',';
               ```
         ...
         2. RedshiftSpectrum向けのテーブル定義作成(varchar指定)
            ...
            1. ```sql
               ...
               stored as               textfile
               location                's3://euks-testbucket/varchar_test/data/'
               ;
               ```
