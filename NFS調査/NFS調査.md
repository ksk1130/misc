...
[root@localhost suke]# mount -v -t nfs 192.168.0.59:/share /share
...
[root@localhost suke]# ls -R /share
/share:
dirB
...
```sh
[root@localhost suke]# mount -v -t nfs 192.168.0.59:/share/dirA /share
